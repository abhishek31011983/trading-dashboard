...
# Account Size tab columns:
# A=0 Date, B=1 Nifty Prev Close, C=2 Deposits/Withdrawals, D=3 Portfolio Size,
# E=4 Weekly Change, F=5 Cannot go below, G=6 Friday ending,
# H=7 MTF Loan, I=8 Net Equity, J=9 Leverage Ratio
    ...
    for row in account_raw[1:]:
        if len(row) >= 4 and row[0]:
            account_data.append({
                ...
                "cannot_go_below":    row[5] if len(row) > 5 else "",
